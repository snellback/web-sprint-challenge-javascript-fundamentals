...
const zooAnimals = [
  ...
  */
  ...
  function lowPopulationAnimals(animalArray){
    const smallPop = animalArray.filter(animal => animal.population < 5);
    return smallPop;
  }
  ...
  */
  ...
  function USApop(animalArray){
    const totalPop = animalArray.reduce((acc, animal) => acc + animal.population, 0);
    return totalPop;
  }
